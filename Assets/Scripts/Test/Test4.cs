...
public class Test4 : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        if (useDelaunay && delaunayTriangles != null)
        {
            DrawDelaunayGizmos();
        }
    }
    ...
    void GenerateDelaunayTriangulation()
    {
        ...
        // Generar triangulación Delaunay usando Bowyer-Watson
    ...
    void DrawDelaunayGizmos()
    {
        ...
        Gizmos.color = new Color(0.5f, 0.5f, 1f, 0.3f); // Azul semi-transparente
