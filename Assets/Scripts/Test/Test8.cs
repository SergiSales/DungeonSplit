...
public class Test8 : MonoBehaviour
{
    ...
    [Range(0f, 200f)] public float roomCrossPenalty = 50f;
    [Range(0f, 2f)] public float turnPenalty = 0.35f;
    [Range(0.1f, 2f)] public float existingCorridorCost = 0.75f;
    ...
    List<Vector2Int> FindPathAStar(Vector2Int start, Vector2Int goal, int startRoomIndex, int endRoomIndex, bool allowRoomPenalty)
    {
        ...
        while (openSet.Count > 0)
        {
            ...
            foreach (Vector2Int direction in CardinalDirections)
            {
                ...
                float tentativeScore = gScore[current] + traversalCost + GetTurnPenalty(cameFrom, current, neighbor);
